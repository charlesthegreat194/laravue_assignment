...
<template>
    ...
    <div>
        <a href="" class=" text-red-500 text-lg border-2 border-red-500 shadow-sm p-3 rounded-md
       hover:bg-red-500 hover:text-white duration-500 ease-in-out" @click="whenClicked">Sign In</a>
    </div>
  </nav>
