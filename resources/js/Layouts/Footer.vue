<template>
  <footer class="border-t-4 border-gray-600 font-popins bg-semiblack-0 text-white px-20 mt-20 bottom-0 w-full h-40">
    ...
    <div class="p-2 flex items-center justify-center space-x-4">
      ...
      <!-- Reddit Icon -->
      <a href="#" class="text-white" @click="goReddit">
        <svg
          class="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- LinkedIn Icon -->
      <a href="#" class="text-white" @click="goLinkedIn">
        <svg
          class="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- Twitter Icon -->
      <a href="#" class="text-white" @click="goTwitter">
        <svg
          class="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="text-center mt-2">
      <!-- Copyright Notice -->
      <p class="font-mono text-sm text-gray-300 text-center">
